<template>
  <MyDialog title="取消订单" v-model:visible="visibleDialog">
    <!-- 取消原因列表 -->
    ...
    <!-- 按钮操作 -->
    <template #footer>
      <MyButton type="gray" @click="visibleDialog=false" style="margin-right:20px">取消</MyButton>
...
<script>
import { ref } from 'vue'
import { cancelReason } from '@/api/constance'
