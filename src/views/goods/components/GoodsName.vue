<template>
  ...
  <div class="g-service">
    ...
    <dl>
      <dt>配送</dt>
      <dd>至 <City @changeCity="changeCity" :fullLocation="fullLocation" /></dd>
    </dl>
    <dl>
      <dt>服务</dt>
      <dd>
...
export default {
  ...
  setup (props) {
    ...
    const changeCity = (newCity) => {
      provinceCode.value = newCity.provinceCode
      cityCode.value = newCity.cityCode
      countyCode.value = newCity.countyCode
      fullLocation.value = newCity.fullLocation
    }
